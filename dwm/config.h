...
/* appearance */
static const char font[]            = "-misc-fixed-medium-r-semicondensed--13-100-100-100-c-60-*-1";
...
/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "6", "7", "8", "IM" };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,		        XK_Return, spawn,          {.v = roxcmd } },
